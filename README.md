...
Les différentes classes de conteneurs sont : 
  ...
  * dbclient  (image propre à l'application basée sur jamesbrink/postgresql): va créer la base de données entrepot sur le serveur Postgres contenant la table Postgis communes (basée sur jamesbrink/postgresql)
